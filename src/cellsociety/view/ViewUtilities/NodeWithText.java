...
/**
 * Classes which implement this interface will have elements that can change their text. This
 * interface was made to assist with changing the text when the language is changed.
 *
